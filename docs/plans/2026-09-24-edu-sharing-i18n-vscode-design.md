...
dürfen höchstens 1000 Zeichen lang sein; eine mehr als dreimal wiederholte Gruppe, die selbst mit einem wiederholten
Teil beginnt (`(a+)+`, `(a+){1,20}`), weist die Erweiterung ab, weil sie exponentiell lange laufen kann (Audit S-06).
Ein Lookaround am Anfang zählt dabei nicht, er verbraucht keine Zeichen.
